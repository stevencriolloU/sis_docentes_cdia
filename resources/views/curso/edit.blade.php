                    ...
                    <div class="w-full">
                        <div class="bg-gray-500 rounded-lg p-6 shadow flex flex-col justify-center items-center">
                            <div class="flex items-center justify-between sm:flex-auto">
                                <h1 class="mt-2 font-semibold text-white">Actualizar {{ __('Curso') }} Existente</h1>
                        ...
                        <div class="flow-root">
                            <div class="overflow-x-auto">
                                <div class="max-w-xl py-2 align-middle mx-auto">
                                    <form method="POST" class="flex-col justify-center items-center" action="{{ route('cursos.update', $curso->id) }}"  role="form" enctype="multipart/form-data">
                                        {{ method_field('PATCH') }}
                                        @csrf
                                        @include('curso.form')
                                    </form>
