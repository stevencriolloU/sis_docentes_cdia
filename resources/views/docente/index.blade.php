                    ...
                    <div class="w-full">
                        <div class="bg-gray-500 rounded-lg p-6 shadow flex flex-col justify-center items-center">
                            <div class="flex items-center justify-between sm:flex-auto">
                                <h1 class="mt-2 font-semibold text-white">Lista de {{ __('Docentes') }} Existentes.</h1>
                                <img src="{{ asset('images/Docentes.svg') }}" alt="Icono de inicio de sesión" class="h-8 w-8 ml-4">
                            </div>
                        </div>
                                ...
                                <div class="inline-block min-w-full py-2 text-center rounded-lg align-middle bg-gray-500">
                                    <table class="w-full divide-y divide-gray-300 text-center">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" class="py-3 pl-4 pr-3 text-l font-semibold uppercase tracking-wide text-white">Nombre del Docente</th>
                                            <th scope="col" class="py-3 pl-4 pr-3 text-l font-semibold uppercase tracking-wide text-white">Contrato</th>
                                        ...
                                        @foreach ($docentes as $docente)
                                            <tr class="even:bg-gray-50">
                                                ...
                                                <td class="whitespace-nowrap py-4 pl-4 pr-5 text-center text-sm font-medium text-gray-900">
                                                    <form action="{{ route('docentes.destroy', $docente->id) }}" method="POST" class="flex justify-center">
                                                        ...
                                                        @csrf
                                                        @method('DELETE')
                                                        <a href="{{ route('docentes.destroy', $docente->id) }}" 
                                    ...
                                    <div class="text-center items-center">
                                        <a type="button" href="{{ route('docentes.create') }}" 
