                    ...
                    <div class="w-full">
                        <div class="bg-gray-500 rounded-lg p-6 shadow flex flex-col justify-center items-center">
                            <div class="flex items-center justify-between sm:flex-auto">
                                <h1 class="mt-2 font-semibold text-white">Lisa de {{ __('Preguntas') }} Existentes</h1>
                                <img src="{{ asset('images/preguntas.svg') }}" alt="Icono de inicio de sesión" class="h-8 w-8 ml-4">
                            </div>
                        </div>
                                ...
                                <div class="inline-block min-w-full py-2 text-center rounded-lg align-middle bg-gray-500">
                                    <table class="w-full divide-y divide-gray-300 text-center">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col" class="py-3 pl-4 pr-3 text-l font-semibold uppercase tracking-wide text-white">Tipo Pregunta</th>
                                            <th scope="col" class="py-3 pl-4 pr-3 text-l font-semibold uppercase tracking-wide text-white">Escala</th>
                                        ...
                                        @foreach ($preguntas as $pregunta)
                                            <tr class="even:bg-gray-50">
                                                ...
                                                <td class="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">
                                                    <form action="{{ route('preguntas.destroy', $pregunta->id) }}" method="POST" class="flex justify-center">
                                                        ...
                                                        @csrf
                                                        @method('DELETE')
                                                        <a href="{{ route('preguntas.destroy', $pregunta->id) }}" 
                                    ...
                                    <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
                                        <a type="button" href="{{ route('preguntas.create') }}" 
